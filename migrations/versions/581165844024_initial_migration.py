...
Revision ID: 581165844024
Revises: 
Create Date: 2025-04-02 16:59:56.677910
...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['student_id'], ['user.id'], name='fk_ssip_student'),
    sa.PrimaryKeyConstraint('id')
    )
